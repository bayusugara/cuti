          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= base_url('pegawai/datapribadi/profile');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?=base_url('pegawai/datapribadi/profile');?>">
        ...
        <li>
          <a href="<?=base_url('pegawai/cuti');?>">
            <i class="fa fa-external-link-square"></i> <span>Pengajuan Cuti</span>
          </a>
        </li>
        <li>
          <a href="<?=base_url('pegawai/cuti/riwayat');?>">
            <i class="fa fa-database"></i> <span>Riwayat Cuti</span>
          </a>
        </li>
      </ul>
    </section>
