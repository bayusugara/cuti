...
<?php foreach ($pegawai as $u) { ?>
    <a class="btn btn-warning" href="<?= base_url('pegawai/pegawai');?>">Cancel </a>
<div class="box box-default">
  ...
  <div class="box-body">
    <div class="row" style="font-size: 13pt;">
      <div class="col-md-6">
        ...
        <div class="form-group">
            <label class="col-md-5">Departmen</label><label>: <span class="label label-primary label-form"><?=$u->departmen;?> </span></label>
        </div>
        <div class="form-group">
            <label class="col-md-5">Tempat Tanggal Lahir</label><label>: <span class="label label-primary label-form"><?=$u->lahir;?> </span></label>
        </div>
        <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="form-group">
            <label class="col-md-5">Golongan Darah</label><label>: <span class="label label-primary label-form"><?=$u->darah;?> </span></label>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-md-5">Alamat</label><label>: <span class="label label-primary label-form"><?=$u->alamat;?> </span></label>
        </div>
        <!-- /.form-group -->
      </div>
      <!-- /.col -->
