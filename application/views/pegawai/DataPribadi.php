...
<?php foreach ($tampil as $u) { ?>
    ...
    <a class="btn btn-danger" href="#edit<?=$u->idauth;?>" data-toggle="modal">Edit Password </a>
    ...
    <div class="row" style="font-size: 13pt;">
      <div class="col-md-6">
        <div class="form-group">
            <label class="col-md-5">Nip</label><label>: <span class="label label-danger label-form"><?=$u->nik;?> </span></label>
        </div>
        <div class="form-group">
...
<?php foreach($tampil as $u) { ?>
        <div class="modal modal-danger fade" id="edit<?=$u->idauth;?>">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Edit Password : <?=$u->nama;?></h4>
              </div>
              <form id="jvalidate" role="form" class="form-horizontal" action="<?=base_url('pegawai/datapribadi/updatepassword');?>" method="post">
                ...
                <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="col-md-3 control-label">Level:</label>
                            <div class="col-md-3">
                          <select class="form-control select2" disabled="disabled" data-live-search="true" id="formGender" name="level" required">
                            <option value="">Choose option</option>
                            <option value="1" <?php if ($u->level == 1) {echo "selected";}?>>Kabapas</option>
                            ...
                            <option value="4" <?php if ($u->level == 4) {echo "selected";}?>>Tata Usaha</option>
                          </select>
                            </div>
                        </div>
              </div>
        ...
        <div class="modal modal-success fade" id="edit<?=$u->nik;?>">
          <div class="modal-dialog modal-lg ">
            <div class="modal-content">
              ...
              <form id="jvalidate" role="form" class="form-horizontal" action="<?=base_url('pegawai/datapribadi/updatedatapribadi');?>" method="post">
              <div class="modal-body">
                <div class="row">
                <div class="col-md-6">
                <div class="form-group">
