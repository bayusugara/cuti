...
<?php foreach ($pegawai as $u) { ?>
    <a class="btn btn-success" href="#edit<?=$u->nik;?>" data-toggle="modal">Edit </a>
    <a class="btn btn-warning" href="<?= base_url('tatausaha/pegawai');?>">Cancel </a>
<div class="box box-default">
        ...
        <div class="modal modal-success fade" id="edit<?=$u->nik;?>">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form id="jvalidate" role="form" class="form-horizontal" action="<?=base_url('tatausaha/pegawai/update');?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select class="form-control select2" data-live-search="true" style="width: 100%;" id="formGender" name="jabatan" required">
                            ...
                            <option <?php if ($u->jabatan == 'Pengtatausahaistrasian Umum'){echo 'selected';}?>>Pengtatausahaistrasian Umum</option>
