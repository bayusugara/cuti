        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Tata Usaha</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= base_url('tatausaha/datapribadi/profile');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('tatausaha/pegawai')?>"><i class="fa fa-users"></i> Data Pegawai</a></li>
            <li><a href="<?php echo base_url('tatausaha/user')?>"><i class="fa fa-user"></i> Data User</a></li>
          </ul>
        </li>
        <li>
          <a href="<?php echo base_url('tatausaha/cuti/cetakcuti')?>">
            <i class="fa fa-external-link-square"></i> <span>Cetak Cuti Pegawai</span>
            <small class="label pull-right bg-green">
              <?php if ($happroved == NULL) {
                  echo "0";
                }else{
                  foreach($happroved as $a){
                    echo $a->jumlah; 
                }
              }?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('tatausaha/laporan/pegawai')?>"><i class="fa fa-user"></i> Laporan Pegawai</a></li>
            <li><a href="<?php echo base_url('tatausaha/laporan/cuti')?>"><i class="fa fa-external-link-square"></i> Laporan Cuti Pegawai</a></li>
          </ul>
        </li>
      </ul>
    </section>
...
<script>
  $(function () {
    ...
    var PieData        = [
      {
        value    : <?php foreach ($janda as $u){echo $u->jumlah;}?>,
        color    : '#f56954',
        highlight: '#f56954',
        label    : 'Janda'
      },
      {
        value    : <?php foreach ($duda as $u){echo $u->jumlah;}?>,
        color    : '#00a65a',
        highlight: '#00a65a',
        label    : 'Duda'
      },
      {
        value    : <?php foreach ($lajang as $u){echo $u->jumlah;}?>,
        color    : '#f39c12',
        highlight: '#f39c12',
        label    : 'Lajang'
      },
      {
        value    : <?php foreach ($menikah as $u){echo $u->jumlah;}?>,
        color    : '#00c0ef',
        highlight: '#00c0ef',
        label    : 'Menikah'
      }
