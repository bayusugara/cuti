<div class="content-wrapper">
    ...
    <section class="content">
      <div class="callout callout-warning">
        ...
        <p>Sebelum menyetujui cuti pegawai, diharapkan kabapas untuk melihat detail cuti.</p>
      </div>
                            <!-- /.box-body -->
                ...
                <div class="row">
                  <div class="col-md-12">
                      <div class="box box-info box-solid">
                        <div class="box-header with-border">
                          <h3 class="box-title"><strong>Persetujuan Kabapas <i class="fa fa-hourglass-start"></i></strong></h3>
                        ...
                        <div class="box-body">
                            ...
                            <?php $no =1; foreach($teruskan as $a) { ?>
                                <tr>
        ...
        <div class="modal modal-danger fade" id="tolak<?=$a->idcuti;?>">
          <div class="modal-dialog modal-md">
            <div class="modal-content">
              ...
              <form id="jvalidate" role="form" class="form-horizontal" action="<?=base_url('kabapas/cuti/updatepending');?>" method="post">
          ...
          <div class="modal-dialog modal-md">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <div class="col-md-12">
                    <h4>Apakah anda yakin ingin menyetujui pengajuan cuti ini ?</h4>
                    <input type="hidden" name="idcuti" value="<?=$a->idcuti;?>">
