              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $no = 1; foreach ($pegawai as $u) { ?>
                    <tr>
                        ...
                        <a href="<?=base_url('kabapas/pegawai/detailpegawai/'.$u->nik);?>"><span class="glyphicon glyphicon-eye-open" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Lihat"></span></a></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
