        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Kepala Bapas</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= base_url('kabapas/datapribadi/profile');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url('kabapas/pegawai')?>">
            <i class="fa fa-users"></i> <span>Data Pegawai</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('kabapas/cuti/pending')?>">
            <i class="fa fa-external-link-square"></i> <span>Cuti Pegawai</span>
            <small class="label pull-right bg-blue">
              <?php if ($hteruskan == NULL) {
                  echo "0";
                }else{
                  foreach($hteruskan as $a){
                    echo $a->jumlah; 
                }
              }?>
        ...
        <li>
          <a href="<?php echo base_url('kabapas/laporan/cuti')?>">
